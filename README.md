# java-test-0005-final-14748-sourav
...
2. try-catch-finally block (for handling any internal execution error and closing the scanner class instance)
3. for loop (for iterate row and column wise)
